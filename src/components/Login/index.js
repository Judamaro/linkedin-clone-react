    ...
    <>
      {register ? (
        <div className="login">
          <div className="login-container">
            ...
            <div className="login-form">
              ...
              <p>Mantente al día con tu mundo profesional</p>
        ...
        <div className="login register">
          <div className="login-container">
            <div className="login-logo register">
              <svg
                width="102"
                height="26"
                viewBox="0 0 102 26"
            ...
            <h2 className="login-text register">
              Sacale el máximo partido a tu vida profesional
            </h2>
            <div className="login-form register">
              <form onSubmit={handleRegister}>
                ...
                <p>
                  Al hacer click en "Aceptar y Unirse", aceptas las{" "}
                  <span>Condiciones de uso</span>, la{" "}
                  <span>Política de privacidad</span> y la{" "}
                  <span>Política de cookies</span> de LinkedIn.
                </p>
                <br />
                <Button
                  variant="contained"
            ...
            <p className="login-footer">
              ¿Ya eres usuario de LinkedIn?
              <span onClick={() => setRegister(true)}>Inicia Sesión</span>
            </p>
          </div>
        </div>
      )}
